...
<?php $__env->startSection('description', 'Susunan kepengurusan UKM-IT Cyber Open Source berdasarkan periode.'); ?>
                ...
                <div class="inline-block relative w-64 text-left">
                    <select onchange="window.location.href=this.value" class="block appearance-none w-full bg-white border border-gray-300 text-gray-700 py-3 px-4 pr-8 rounded-lg shadow leading-tight focus:outline-none focus:ring-2 focus:ring-primary-navy focus:border-primary-navy font-semibold cursor-pointer">
                        ...
                        <?php $__currentLoopData = $periods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e(route('public.organisasi.period', $p->id)); ?>" <?php echo e($selectedPeriod && $p->id == $selectedPeriod->id ? 'selected' : ''); ?>>
...
<section class="section-spacing bg-gray-50/50" style="min-height: 60vh;">
    <div class="section-container" style="max-width: 1400px; overflow-x: auto; overflow-y: visible;">
        <?php if($selectedPeriod && $managements->count() > 0): ?>
                ...
                <ul>
                    ...
                    <li>
                        <div class="org-node ketua">
                            <div class="org-photo">
                                <?php if($ketua->member->photo): ?>
                                    <img src="<?php echo e(asset('images/' . $ketua->member->photo)); ?>" alt="<?php echo e($ketua->member->name); ?>">
                                <?php else: ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-5 h-5 text-gray-300']); ?>
...
<?php endif; ?>
                            ...
                            <div class="org-info">
                                <h4><?php echo e($ketua->member->name); ?></h4>
                                <p><?php echo e($ketua->position->name); ?></p>
                                <p class="nia">NIA: <?php echo e($ketua->member->nta ?? $ketua->member->nim ?? '-'); ?></p>
                            </div>
                        </div>
                                    ...
                                    <div class="org-group-inti">
                                        <?php if($sekretaris): ?>
                                            <div class="org-node inti">
                                                <div class="org-photo">
                                                    <?php if($sekretaris->member->photo): ?>
                                                        <img src="<?php echo e(asset('images/' . $sekretaris->member->photo)); ?>" alt="<?php echo e($sekretaris->member->name); ?>">
                                                    <?php else: ?>
                                                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                                                ...
                                                <div class="org-info">
                                                    <h4><?php echo e($sekretaris->member->name); ?></h4>
                                                    <p><?php echo e($sekretaris->position->name); ?></p>
                                                    <p class="nia">NIA: <?php echo e($sekretaris->member->nta ?? $sekretaris->member->nim ?? '-'); ?></p>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <?php if($bendahara): ?>
                                            <div class="org-node inti">
                                                <div class="org-photo">
                                                    <?php if($bendahara->member->photo): ?>
                                                        <img src="<?php echo e(asset('images/' . $bendahara->member->photo)); ?>" alt="<?php echo e($bendahara->member->name); ?>">
                                                    <?php else: ?>
                                                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                                                ...
                                                <div class="org-info">
                                                    <h4><?php echo e($bendahara->member->name); ?></h4>
                                                    <p><?php echo e($bendahara->position->name); ?></p>
                                                    <p class="nia">NIA: <?php echo e($bendahara->member->nta ?? $bendahara->member->nim ?? '-'); ?></p>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <?php if(count($divisiData) > 0): ?>
                                        <ul>
                                            <?php $__currentLoopData = $divisiData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $div): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li>
                                                    
                                                    <?php if($div['kabid']): ?>
                                                        <div class="org-node kabid">
                                                            <div class="org-photo">
                                                                <?php if($div['kabid']->member->photo): ?>
                                                                    <img src="<?php echo e(asset('images/' . $div['kabid']->member->photo)); ?>" alt="<?php echo e($div['kabid']->member->name); ?>">
                                                                <?php else: ?>
                                                                    <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                                                            ...
                                                            <div class="org-info">
                                                                <h4><?php echo e($div['kabid']->member->name); ?></h4>
                                                                <p><?php echo e($div['kabid']->position->name); ?></p>
                                                                <p class="nia">NIA: <?php echo e($div['kabid']->member->nta ?? $div['kabid']->member->nim ?? '-'); ?></p>
                                                            </div>
                                                        </div>
                                                    <?php else: ?>
                                                        ...
                                                        <div class="org-node kabid" style="opacity: 0.5;">
                                                            <div class="org-info" style="padding: 20px;">
                                                                ...
                                                                <p>Kepala <?php echo e($div['name']); ?></p>
                                                            </div>
                                                        </div>
                                                    <?php endif; ?>

                                                    
                                                    <?php if(count($div['anggota']) > 0): ?>
                                                    <ul>
                                                        <?php $__currentLoopData = $div['anggota']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li>
                                                                <div class="org-node anggota">
                                                                    <div class="org-photo" style="aspect-ratio: auto; height: 140px;">
                                                                        <?php if($ang->member->photo): ?>
                                                                            <img src="<?php echo e(asset('images/' . $ang->member->photo)); ?>" alt="<?php echo e($ang->member->name); ?>">
                                                                        <?php else: ?>
                                                                            <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                                                                    ...
                                                                    <div class="org-info">
                                                                        <h4><?php echo e($ang->member->name); ?></h4>
                                                                        <p><?php echo e($ang->position->name); ?></p>
                                                                        <p class="nia">NIA: <?php echo e($ang->member->nta ?? $ang->member->nim ?? '-'); ?></p>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="org-mobile">
                ...
                <div class="om-node-wrap">
                    <div class="om-card om-ketua">
                        <div class="om-photo">
                            <?php if($ketua->member->photo): ?>
                                <img src="<?php echo e(asset('images/' . $ketua->member->photo)); ?>"
                                     alt="<?php echo e($ketua->member->name); ?>">
                            <?php else: ?>
                                <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                        ...
                        <div class="om-info">
                            <h4><?php echo e($ketua->member->name); ?></h4>
                            <p class="om-position"><?php echo e($ketua->position->name); ?></p>
                            <p class="om-nia">NIA: <?php echo e($ketua->member->nta ?? $ketua->member->nim ?? '-'); ?></p>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
                ...
                <div class="om-node-wrap">
                    <div class="om-card om-inti">
                        <div class="om-photo">
                            <?php if($sekretaris->member->photo): ?>
                                <img src="<?php echo e(asset('images/' . $sekretaris->member->photo)); ?>"
                                     alt="<?php echo e($sekretaris->member->name); ?>">
                            <?php else: ?>
                                <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                        ...
                        <div class="om-info">
                            <h4><?php echo e($sekretaris->member->name); ?></h4>
                            <p class="om-position"><?php echo e($sekretaris->position->name); ?></p>
                            <p class="om-nia">NIA: <?php echo e($sekretaris->member->nta ?? $sekretaris->member->nim ?? '-'); ?></p>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
                ...
                <div class="om-node-wrap">
                    <div class="om-card om-inti">
                        <div class="om-photo">
                            <?php if($bendahara->member->photo): ?>
                                <img src="<?php echo e(asset('images/' . $bendahara->member->photo)); ?>"
                                     alt="<?php echo e($bendahara->member->name); ?>">
                            <?php else: ?>
                                <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                        ...
                        <div class="om-info">
                            <h4><?php echo e($bendahara->member->name); ?></h4>
                            <p class="om-position"><?php echo e($bendahara->position->name); ?></p>
                            <p class="om-nia">NIA: <?php echo e($bendahara->member->nta ?? $bendahara->member->nim ?? '-'); ?></p>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
                ...
                <?php $__currentLoopData = $divisiData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $div): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="om-divisi-block">
                        ...
                        <p class="om-section-label" style="margin-bottom:0;"><?php echo e($div['name']); ?></p>
                        ...
                        <div class="om-node-wrap">
                            <div class="om-card om-kabid">
                                <div class="om-photo">
                                    <?php if($div['kabid']->member->photo): ?>
                                        <img src="<?php echo e(asset('images/' . $div['kabid']->member->photo)); ?>"
                                             alt="<?php echo e($div['kabid']->member->name); ?>">
                                    <?php else: ?>
                                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                                ...
                                <div class="om-info">
                                    <h4><?php echo e($div['kabid']->member->name); ?></h4>
                                    <p class="om-position"><?php echo e($div['kabid']->position->name); ?></p>
                                    <p class="om-nia">NIA: <?php echo e($div['kabid']->member->nta ?? $div['kabid']->member->nim ?? '-'); ?></p>
                                </div>
                            </div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="om-anggota-grid">
                            ...
                            <div class="om-card om-anggota">
                                <div class="om-photo">
                                    <?php if($ang->member->photo): ?>
                                        <img src="<?php echo e(asset('images/' . $ang->member->photo)); ?>"
                                             alt="<?php echo e($ang->member->name); ?>">
                                    <?php else: ?>
                                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                                ...
                                <div class="om-info">
                                    <h4><?php echo e($ang->member->name); ?></h4>
                                    <p class="om-position"><?php echo e($ang->position->name); ?></p>
                                    <p class="om-nia">NIA: <?php echo e($ang->member->nta ?? $ang->member->nim ?? '-'); ?></p>
                                </div>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-5 h-5 mx-auto text-gray-300 mb-6']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SEMESTER 4\PEMROGRAMAN WEB 2\LARAVELL\website-cos\resources\views/public/organization.blade.php ENDPATH**/ ?>