...
@section('description', 'Profil, visi, dan misi UKM-IT Cyber Open Source.')
    ...
    <div class="section-container">
        ...
        <div class="about-content-grid">
            ...
            <div class="about-main-column">
                ...
                {{-- SEJARAH --}}
                @if(\App\Models\Setting::get('org_history'))
        ...
        <div class="hidden lg:block philosophy-diagram">
            ...
            <div class="philosophy-penguin">
                ...
                <div class="penguin-philosophy-card flex flex-col items-center">
                    ...
                    <div class="mb-2">
                        <img src="{{ asset('images/tux.png') }}" alt="Tux Linux Penguin" style="width: 32px; height: 32px;" class="object-contain">
                    </div>
        ...
        <div class="lg:hidden mobile-philosophy">
            ...
            <div class="mobile-timeline">
                ...
                <div class="reveal fade-up mobile-timeline-item">
                    ...
                    {{-- Connector line uses gray for neutral penguin --}}
                    ...
                    <div class="mobile-philosophy-card flex flex-col items-center text-center !p-5 w-full">
                        ...
                        <div class="mb-2">
                            <img src="{{ asset('images/tux.png') }}" alt="Tux Linux Penguin" style="width: 28px; height: 28px;" class="object-contain">
                        </div>
                    ...
                    <div class="reveal fade-up mobile-timeline-item">
                        ...
                        <div class="mobile-philosophy-card">
                            ...
                            <div class="mobile-card-heading">
                                ...
                                <span
                                    class="mobile-color-dot {{ $item['dot'] }}">
                                </span>
