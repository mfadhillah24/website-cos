...
@section('title', 'Tambah Agenda Organisasi')
@section('page_title', 'Tambah Agenda Organisasi')

@section('content')
<div class="card">
    <div class="card-header">
        <h2 class="card-title">Tambah Agenda Organisasi</h2>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.agendas.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="type" value="{{ old('type') }}" class="form-control" placeholder="Contoh: Rapat, Kegiatan, Pelatihan">
            </div>

            <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                <div class="form-group">
                    <label class="form-label">Tanggal Mulai <span style="color:red">*</span></label>
                    <input type="date" name="agenda_date" id="agenda_date" value="{{ old('agenda_date') }}" class="form-control @error('agenda_date') is-invalid @enderror" required>
            ...
            <div class="form-group">
                ...
                <input type="text" name="participants" value="{{ old('participants') }}" class="form-control" placeholder="Contoh: Semua Pengurus">
            </div>
