...
@section('breadcrumb', 'Sistem / Pengumuman / Buat')

@section('content')
<div style="max-width: 600px;">
    <div class="card">
        <div class="card-header">
            <h2 class="card-title">Pengumuman Baru</h2>
            ...
            <form method="POST" action="{{ route('admin.announcements.store') }}">
                ...
                <div class="form-group">
                    ...
                    <textarea id="content" name="content" rows="4"
                        class="form-control {{ $errors->has('content') ? 'is-invalid' : '' }}" required>{{ old('content') }}</textarea>
                ...
                <div class="form-group" style="display:flex; align-items:center; gap:8px;">
                    <input type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} style="width:16px; height:16px;">
