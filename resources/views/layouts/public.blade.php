            ...
            <div class="section-container py-3 pb-5 flex flex-col gap-1">
                ...
                <div>
                    ...
                    <div id="mob-acc-tentang" class="mobile-accordion-content {{ $isTentangActive ? 'open' : '' }}">
                        <a href="{{ route('public.tentang') }}" class="mobile-accordion-item {{ request()->routeIs('public.tentang') ? 'active' : '' }}">Tentang COS</a>
                        <a href="{{ route('public.organisasi') }}" class="mobile-accordion-item {{ request()->routeIs('public.organisasi') ? 'active' : '' }}">Organisasi</a>
                        <a href="{{ route('public.divisi') }}" class="mobile-accordion-item {{ request()->routeIs('public.divisi') || request()->routeIs('public.divisi.show') ? 'active' : '' }}">Divisi</a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div id="mob-acc-aktivitas" class="mobile-accordion-content {{ $isAktivitasActive ? 'open' : '' }}">
                        <a href="{{ route('public.kegiatan') }}" class="mobile-accordion-item {{ request()->routeIs('public.kegiatan') || request()->routeIs('public.kegiatan.show') ? 'active' : '' }}">Kegiatan</a>
                        <a href="{{ route('public.berita') }}" class="mobile-accordion-item {{ request()->routeIs('public.berita') || request()->routeIs('public.berita.show') ? 'active' : '' }}">Berita</a>
                        <a href="{{ route('public.galeri') }}" class="mobile-accordion-item {{ request()->routeIs('public.galeri') ? 'active' : '' }}">Galeri</a>
                    </div>
                </div>
